...
namespace Repetition_Inheritance
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            dieselBils.Add(new DieselBil("BMW", 5000, 2006, 10, "23r23r"));
            dieselBils.Add(new DieselBil("Porche", 4700, 2015, 32,"hewh45h"));
            dieselBils.Add(new DieselBil("Skoda", 3900, 2004, 20,"w4h4h5h4", false));
            dieselBils.Add(new DieselBil("Kia", 6300, 2013, 15,"jt6tyrj"));
            dieselBils.Add(new DieselBil("Lamboghini", 7600, 2014, 26,"gw54g4g", false));
