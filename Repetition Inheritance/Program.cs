...
namespace Repetition_Inheritance
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bils.Add(new BenzinBil("Porche", 240000, 2004, 20, "b8um5r", 3));
            bils.Add(new BenzinBil("Skoda", 80000, 2004, 29, "mvw9wv4", 122));
            bils.Add(new BenzinBil("Kia", 740000, 2004, 15, "9wmvw4v", 8));
            bils.Add(new BenzinBil("Lamboghini", 1400000, 2004, 9, "a9je4rv", 5));
            bils.Add(new ElBil("BMW", 250000, 2010, "3D2S", 10, 20));
            bils.Add(new ElBil("Nissan", 170000, 2017, "4D2W", 5, 50));
            bils.Add(new ElBil("Toyota", 150000, 2017, "9F4T", 5, 15));
            bils.Add(new ElBil("cheveolet", 200000, 2017, "8Y5C", 10, 23));
            bils.Add(new ElBil("Tesla", 700000, 2017, "7UP9", 10, 60));
            ...
            foreach (Bil bil in bils)
            {
                ...
                if (bil is BenzinBil)
                {
                    BenzinBil benzin = bil as BenzinBil;
                    Console.WriteLine("Mærke: "  + benzin.Mærke  +   "   Bilens pris er: " + benzin.BilPrisExAfgift    +    "   Købt: "   + benzin.KøbsÅr   +   "    RegistreringNr: "  +  benzin.RegistreringsNr + "     Den halvårlige ejerafgift er: "  + benzin.HalvÅrligEjerafgift()  + " Rækkevidde: " + benzin.Rækkevidde());
